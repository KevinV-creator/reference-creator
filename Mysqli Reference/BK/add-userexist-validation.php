...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Validate first name and last name to contain only alphabetic characters
    if (!preg_match("/^[a-zA-Z]+$/", $first_name)) {
        echo "<p style='color:red;'>First name can only contain alphabetic characters!</p>";
    } elseif (!preg_match("/^[a-zA-Z]+$/", $last_name)) {
        echo "<p style='color:red;'>Last name can only contain alphabetic characters!</p>";
    } else {
